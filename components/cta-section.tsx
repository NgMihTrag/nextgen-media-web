        ...
        >
          ...
          >
            <Button 
              size="lg" 
              onClick={openModal}
              className="bg-blue-600 hover:bg-blue-500 text-white px-8 h-12 font-semibold rounded-lg transition-all duration-300 group whitespace-nowrap cursor-pointer"
            >
              Tư vấn miễn phí
